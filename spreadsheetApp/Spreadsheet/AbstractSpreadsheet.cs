...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// 
        /// This method recursivly iterates through the direct dependents of start
        /// and continues iterating through all the connected cells and 
        /// determines if there are any circular connections
        /// Meaning a1 -> b1 and b1 -> a1
        /// This is not allow in our code
        /// 
        /// It does so by keeping track of the cells visited by the method and if the start value is reached again
        /// that means there is a circular connection and an exeption is thrown. 
        /// If the method gets through all of the connectected cells and there is no circular exeption, changed is returned as the parameter
        /// 
        /// Change is the link list that contains all the cells that need to be updated, and in the right order that they need to be updated
        /// An item is added to change if it has been visited and an exeption is not thrown
        /// 
        /// If this method exicutes corretly, when recalculting cells there should be no errors
        /// </summary>
